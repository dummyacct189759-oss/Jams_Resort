  ...
  return (
    <div className="space-y-8 relative">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Guest Management</h1>
          <p className="text-slate-500 dark:text-slate-400">Manage guest records and history.</p>
        </div>
      ...
      <div className="flex items-center gap-4 bg-white dark:bg-slate-900 p-4 rounded-2xl border dark:border-slate-800 shadow-sm transition-colors">
        ...
        <Button variant="outline" className="rounded-xl dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800">Export CSV</Button>
      </div>
